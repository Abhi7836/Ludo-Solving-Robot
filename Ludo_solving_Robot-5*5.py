...
#############################################################################################################################
def pathplanning(M,m,angle,X,Y,r,image,mar):
        curpos=10
...
def pid(d,m,angle,X,Y,r,image,mar):
        i,j=(d//m),(d%m)
        xi,yi=X//2,Y//2
        Xd,Yd=(i*X)+xi,(j*Y)+yi
        print(X,Y)
        while(True):
                ...
                if len(corners):
                        ...
                        print(Xbp,Ybp,angle,Xd,Yd ,i,j,"f")
                        if angle==0:
                                if Xbp>Xd:
                                        if Ybp > Yd+4 and Ybp < Yd+7:
                                                print("l")
                                                arduino.write(b'l')
                                                time.sleep(.30)
                                        elif Ybp < Yd-4 and Ybp >Yd-7:
                                                print("r")
                                                arduino.write(b'r')
                                                time.sleep(.30)
                                        elif Ybp > Yd+7 and Ybp < Yd+11:
                                                print("a")
                                                arduino.write(b'a')
                                                time.sleep(.50)
                                        elif Ybp < Yd-7 and Ybp >Yd-11:
                                ...
                                if Ybp<Yd:
                                        if Xbp > Xd+4 and Xbp < Xd+7:
                                                print("l")
                                                arduino.write(b'l')
                                                time.sleep(.30)
                                        elif Xbp < Xd-4 and Xbp > Xd-7:
                                                print("r")
                                                arduino.write(b'r')
                                                time.sleep(.30)
                                        elif Xbp > Xd+7 and Xbp < Xd+11:
                                                print("a")
                                                arduino.write(b'a')
                                                time.sleep(.50)
                                        elif Xbp < Xd-7 and Xbp > Xd-11:
...
if __name__ == "__main__":
                ...
                print(M)
                print(ID)
                pathplanning(M,m,angle,X,Y,r,image,mar)
